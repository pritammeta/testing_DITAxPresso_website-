...
jQuery(document).ready(function() {
	...
	/* training-certification-services no margin function by = owl.carousel.js */
	jQuery('.training-certification-services').owlCarousel({
		loop:true,
		autoplay:false,
		margin:30,
		nav:true,
	...
	/* image-carousel no margin function by = owl.carousel.js */
	jQuery('.corporate-training').owlCarousel({
		loop:true,
		autoplay:false,
		margin:0,
		nav:true,
	...
	/*  Our Courses Carousel function by = owl.carousel.js */
	jQuery('.our-courses').owlCarousel({
		loop:true,
		autoplay:false,
		margin:40,
		stagePadding:40,
	...
	/*  testimonial one function by = owl.carousel.js */
	jQuery('.testimonial-meta').owlCarousel({
		loop:true,
		autoplay:false,
		margin:40,
		stagePadding:40,
